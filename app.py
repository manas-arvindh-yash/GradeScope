...
# Streamlit UI
# ------------------------
st.markdown("<h1 style='text-align: center;'>📊 GradeScope: Student Performance Prediction</h1>", unsafe_allow_html=True)

st.markdown("Enter student details below to predict their **Total Score**:")
